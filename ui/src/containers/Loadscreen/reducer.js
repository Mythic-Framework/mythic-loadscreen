...
export const initialState = {
  ...
  name: isProd ? handoverData?.name : "DrBooly",
  priority: isProd ? handoverData?.priority ?? 0 : 3,
  priorityMessage: isProd
    ? handoverData?.priorityMessage
    : "Your supporter priority boost is active.\nThanks for helping fund the server!",
};
